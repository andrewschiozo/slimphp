...
<section class="mt-4 flex items-center">
    ...
    <div class="flex items-end ml-auto">
        <a href="/agenda_reuniao/agendamentos" class="block px-2 py-1 font-semibold hover:text-blue-600">
        ...
        <a href="/agenda_reuniao/agendamentos/proximos" class="block px-2 py-1 font-semibold flex items-center hover:text-blue-600">
            <svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
